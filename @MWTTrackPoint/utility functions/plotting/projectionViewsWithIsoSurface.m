...
hold(ax(1), 'on');
[~,handles.cont_h(1)] = contour(ax(1), xaxis, yaxis, pvstruct.imzp, [pvstruct.isoval pvstruct.isoval], 'w--', 'LineWidth', 2);
hold(ax(1), 'off');

hold(ax(2), 'on');
[~,handles.cont_h(2)] = contour(ax(2), zaxis, yaxis, pvstruct.imxp, [pvstruct.isoval pvstruct.isoval], 'w--', 'LineWidth', 2);
hold(ax(2), 'off');

hold(ax(3), 'on');
[~,handles.cont_h(3)] = contour(ax(3), xaxis, zaxis, pvstruct.imyp, [pvstruct.isoval pvstruct.isoval], 'w--', 'LineWidth', 2);
hold(ax(3), 'off');
