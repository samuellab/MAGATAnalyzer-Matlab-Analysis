function [h,eb] = makeReorientationHistogram_slidingWindow(eset, fieldname, fieldcenters, fieldwidth, windowType, varargin)
%function [h,eb] = makeReorientationHistogram_slidingWindow(eset,
